...
import time, os
# import random
from . import process_data_weibo as process_data
import copy
...
class CNN_Fusion(nn.Module):
    def __init__(self, args, W):
        ...
        model_path = "../models/EANN/vgg19-dcbb9e9d.pth"
...
def main(args):
    ...
    for epoch in range(args.num_epochs):
        ...
        for i, (train_data, train_labels, event_labels, _) in enumerate(train_loader):
        ...
        for i, (validate_data, validate_labels, event_labels, _) in enumerate(validate_loader):
    ...
    test_pred = []
    test_true = []
    for i, (test_data, test_labels, event_labels, _) in enumerate(test_loader):
